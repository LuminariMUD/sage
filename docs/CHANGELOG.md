...
- **Durable Graph Sync Runtime (0.7.5-0.7.7)**
  ...
  - Added staged provider-call intents that reserve hard budget before network I/O, preserve dispatched-call provenance across crashes, and prevent success with incomplete provider calls.
